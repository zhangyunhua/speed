                    ...
                    for (CtBehavior ctBehavior : ctClass.getDeclaredBehaviors()) {
                        ...
                        try {
                            if (ctBehavior.getMethodInfo().isMethod()) {
                                ...
                                String body = "android.util.Log.d(\"TAG\", \"hello\");String str = \"zyh\"; Object argThis = null;";
                                if (!isStatic) {
                                     body += "argThis = $0;";
                                }
...
//                                body += "   if (com.meituan.robust.PatchProxy.isSupport(\$args, argThis, ${Constants.INSERT_FIELD_NAME}, $isStatic, " + methodMap.get(ctBehavior.longName) + ",${parametersClassType},${returnTypeString}.class)) {"
                                body += "   if (str != null && com.meituan.robust.PatchProxy.isSupport($args, argThis, "+Constants.INSERT_FIELD_NAME+", "+isStatic+
